...
void radio_set_sniff(int channel, uint32_t access_address, uint8_t bcc)
{
  // Disable radio
  radio_disable();
  ...
  if (bcc) {
    ...
    NRF_RADIO->BCC = bcc; // This corresponds to advertising address bit offset
  }
...
void radio_tx_to_rx(uint8_t bcc)
{
