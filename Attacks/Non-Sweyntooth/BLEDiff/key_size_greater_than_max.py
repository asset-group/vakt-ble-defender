...
sys.path.insert(0, os.getcwd() + '/../libs')
sys.path.insert(0, os.getcwd() + '/../../Sweyntooth/libs')
import colorama
...
serial_port = discover_attacker_dongle()[0]
...
if len(sys.argv) >= 2:
    ...
    print('Finding target BDAddress (Moto G (5S))')
    advertiser_address = check_output('./find_bdaddress.py').strip()
