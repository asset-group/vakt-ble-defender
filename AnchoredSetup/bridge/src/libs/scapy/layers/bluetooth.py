...
class EIR_Slave_Conn_Interval_Range(EIR_Element):
    name = "Slave Conn. Interval Range"
    fields_desc = [
        LEShortField("int_min", 32),
        LEShortField("int_max", 64),
    ]
...
bind_layers(EIR_Hdr, EIR_Slave_Conn_Interval_Range, type=0x12)
